...
<p style="text-align: center;">
<b>Figura 2.</b> Fator de compressibilidade de N<sub>2</sub>O gasoso em função da pressão, para diferentes temperaturas. Valores plotados foram obtidos a partir do trabalho de Couch & Kobe.^1
</p>
...
<p style="text-align: center;">
<b>Figura 3.</b> Fator de compressibilidade em função de pressão, recíproco do volume molar e densidade, a 150 &deg C, para N<sub>2</sub>O. Valores plotados foram obtidos a partir do trabalho de Couch & Kobe.^1
</p>
...
<div class="mathbox-wrapper">
  <div class="mathbox">
    $$\color{blue}{\boldsymbol{\lim_{p \to 0} Z = \li_{\bar V \to \infty} Z = \lim_{\rho \to 0} Z = 1}}$$
  </div>
  <div class="eq-numbers">
...
<p style="text-align: center;">
<b>Figura 4.</b> Gráfico de $Z$ vs $p$ para N<sub>2</sub>O, a temperaturas de 75, 100 e 150 &deg C. As linhas tracejadas em branco são os ajustes polinomiais de $Z$ em função de $p$ apresentados abaixo. Valores plotados foram obtidos a partir do trabalho de Couch & Kobe.^1
</p>
