...
<p class="jt">
  ...
  P<sub>3</sub> = (p<sub>1</sub>, V<sub>2</sub>, T<sub>3</sub>); <br>
  P<sub>4</sub> = (p<sub>4</sub>, V<sub>2</sub>, T<sub>4</sub>). <br>
</p>
...
<p class="jt">
  Caminho A: $q_{rev,A} = -nRT ln \left( \frac{V_2}{V_1} \right)$ <br>
  Caminho B+C: $q_{rev,B+C} = $q_{rev,B} + $q_{rev,C} = 0 + \int_{T_3}^{T_2} C_V \cdot \frac{dT}{T} = \int_{T_3}^{T_2} C_V \cdot \frac{dT}{T}$ <br>
  Caminho B+C: $q_{rev,B+C} = $q_{rev,B} + $q_{rev,C} = 0 + \int_{T_3}^{T_2} C_V \cdot \frac{dT}{T} = \int_{T_3}^{T_2} C_V \cdot \frac{dT}{T}$ <br>
</p>
