...
<p class="jt">
  ...
  Caminho <span style="color: yellow;">D</span>+<span style="color: blue;">E</span>:  $\boldsymbol{q_{rev,D+E}} = q_{rev,D} + q_{rev,E} = \Delta U_D - w_{rev,D} + \int_{T_3}^{T_1} C_V \cdot dT \\ = \boldsymbol{\int_{T_1}^{T_3} C_V \cdot dT + p_1 \cdot (V_2 - V_1) + \int_{T_3}^{T_1} C_V \cdot dT = p_1 \cdot (V_2 - V_1)}$ <br>
</p>
