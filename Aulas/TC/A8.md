...
<p class="jt">
  A equação <a href="#TC8.3" style="color: blue; font-style: italic;">TC8.3</a> define que a entropia será o diferencial do calor reversível multiplicado por um fator de integração, que Carathéodory definiu como sendo uma função de T, apenas. É possível demonstrar que essa função será: $\lambda(T) = \frac{c}{T}$, sendo $c$ uma constante a ser definida. Desenvolvendo essa expressão, é possível definir o diferencial da entropia como:
</p>
