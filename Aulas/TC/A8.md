...
<p class="jt">
  O próximo passo será considerar a entropia uma propriedade extensiva. Logo, ela também é aditiva e podemos dizer que a variaçãod entropia total será a soma das variações de entropia dos subsistemas A e B. Logo, $dS = dS_A + dS_B = c \cdot \frac{đq_{rev,A}}{T_A} + c \cdot \frac{đq_{rev,B}}{T_B} = c \cdot dU_A \cdot \left(\frac{1}{T_A} - \frac{1}{T_B} \right)$
</p>
