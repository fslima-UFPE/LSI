...
<p class="jt">
  3) Caminho <span style="color: yellow;">D</span>+<span style="color: blue;">E</span>, composto por (D) um aquecimento isobárico reversível de P<sub>1</sub> até P<sub>4</sub> e, (E) um resfriamento isovolumétrico reversível de P<sub>4</sub> até P<sub>2</sub>.
</p>
