...
<p class="jt">
  A entropia (e sua relação com a temperatura) é <b>o ponto central</b> da 3ᵃ. Lei da Termodinâmica. Por isso, vamos revisitá-la e analisar seus diferenciais, agora que tanto a energia interna quanto a entalpia foram devidamente discutidas.
</p>

### Os diferenciais da entropia

<p class="jt">
  A entropia foi introduzida com a 2ᵃ. Lei da Termodinâmica e a conectamos com a 1ᵃ. Lei da Termodinâmica (veja a equação <a href="../A9/#TC9.4" style="color: blue; font-style: italic;">TC9.4</a>). A energia interna não é uma variável prática: podemos controlar facilmente pressão, temperatura e volume, mas não a energia interna. Ao invés disso, vamos escrever o diferencial total de $S=S(T,V)$ e manipular a derivada de $S$ com relação a $T$:
</p>
...
<p class="jt">
e utilizamos definições $\left(\frac{\partial S}{\partial U}\right)_V = \tfrac{1}{T}$ da equação <a href="../A9/#TC9.4" style="color: blue; font-style: italic;">TC9.4</a>, e $\left(\frac{\partial U}{\partial T}\right)_V = C_V$ da equação <a href="../A7/#TC7.11" style="color: black; font-style: italic;">TC7.11a</a> para escrever a equação <a href="#TC13.1" style="color: blue; font-style: italic;">TC13.1</a>. Essa equação é de grande utilidade, pois ela nos permite calcular o valor de $\Delta S$ em função da variação de temperatura.
</p>

### O teorema do calor de Nernst

<p class="jt">
  Com a energia interna e a entalpia discutidas, podemos voltar para a entropia e discutir a última grande lei da termodinâmica que falta, a 3ᵃ. Lei da Termodinâmica. No início do século XX, um físico chamado W. Nernst observou um fato inesperado para a época, que foi transformado em um enunciado conhecido hoje como <b>Teorema de Nernst do calor</b>:
</p>
...
<p class="jt">
  Reparem o teorema se refere a <b>variações</b> de entropia quando a temperatura se aproxima do zero absoluto. O resultado obtido por Nernst era contraditório, pois há tempos a <b>lei de Dulong-Petit</b> era conhecida e estipulava que a capacidade térmica de molar de sólidos monoatômicos seria ${\bar C}_V = 3R$. Essa é uma lei experimental, observada e comprovada para diversos materiais. Contudo, se a capacidade térmica é constante, então não haveria motivos para que a variação de entropia fosse igual a zero, 
</p>
