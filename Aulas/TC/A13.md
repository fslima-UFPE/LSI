...
<div id="TC12.1" class="mathbox-wrapper">
  <div class="mathbox">
    $$\begin{gather}
    \color{blue}{\boldsymbol{\lim \limits_{T \to 0} S = 0}}
    \end{gather}$$
  </div>
