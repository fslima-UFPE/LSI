...
<div class="toolbox" id="zeroth-tool">
    ...
    <p class="jt">
        Esta simulação demonstra a Lei Zero da Termodinâmica. Três recipientes contêm gases a diferentes temperaturas iniciais, separados por paredes diatérmicas (que permitem a troca de energia térmica). Clique em "Gerar Simulação" para calcular as colisões e, em seguida, use os controles para reproduzir o vídeo e observar o sistema atingindo o equilíbrio térmico.
    </p>
    ...
    <div class="toolbox-content">
        <div class="jsbox-control-panel" style="display: flex; gap: 10px; align-items: center; margin-bottom: 15px; flex-wrap: wrap;">
            ...
            <button id="btn-play" class="jsbox-btn" style="background-color: #28a745; color: white; border-color: #28a745;">Reproduzir</button>
            <input type="range" id="inp-scrubber" min="0" max="100" value="0" style="flex-grow: 1; cursor: pointer;">
        </div>
