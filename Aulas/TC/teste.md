...
{% include toolbox.html
    ...
    interactive="<label>a: <input type='range' class='slider-a' min='-5' max='5' step='0.1' value='1'></label> <label>b: <input type='range' class='slider-b' min='-5' max='5' step='0.1' value='0'></label> <canvas class='graph-canvas'></canvas>"
%}
