...
<p class="jt">
  E a entalpia dessa reação? É fácil ver que ela é igual a: $\Delta_r H^o = 1 \times \Delta_f H^o[(CH_3)_2 NH, g] + 2 \times \Delta_f H^o[H_2O, g] - 2 \times \Delta_f H^o[CH_3 OH, g] - 1 \times \Delta_f H^o[NH_3, g]$. Então podemos concluir que é possível reescrever essa expressão em termos de $\Delta_f H^o(i,ef)$ e de $\nu_i$:
</p>
...
<div id="TC12.5" class="mathbox-wrapper">
  ...
  <div class="eq-numbers">    
    <span style="font-weight: bold; color: red;">TC12.5</span>
  </div>
</div>
