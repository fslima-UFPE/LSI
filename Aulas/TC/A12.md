...
<p class="jt">
  Podemos imaginar a seguinte sequência de reações ocorrendo em duas partes. A primeira é a <b>decomposição</b> dos reagentes, isto é, a reação inversa da reação de formação:
</p>
...
<p class="jt">
A soma dessas reações fornecerá: 
</p>
