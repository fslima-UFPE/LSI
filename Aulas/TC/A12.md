...
<p class="jt">
  A primeira reação (<a href="#EC12.5" style="font-weight: bold; color: black;">TC12.5a</a>) nos diz que um equivalente da substância $A$ reage com um equivalente da substância $D$, para formar um equivalente da substância $X$, com entalpia igual a $x kJ.mol^{-1}$. Já a segunda reação (<a href="#EC12.5" style="font-weight: bold; color: black;">TC12.5b</a>) nos diz que um equivalente de $B$ reage para formar um equivalente de $D$ e um equivalente de $Y$, com entalpia igual a $y kJ.mol^{-1}$. Vamos imaginar, agora, o seguinte processo com todas substâncias gasosa e no estado-padrão, a uma temperatura $T$:
</p>
