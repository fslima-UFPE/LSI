...
<div id="EC12.10" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    \color{red}{2CH_3OH(g) \to 2C(grafite) + 4H_2(g) + O_2(g)}\\
    \color{green}{NH_3(g) \to \frac{1}{2}N_2(g) + \frac{3}{2}H_2(g)}\\
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
...
<div id="EC12.11" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    \color{orange}{2C(grafite) + \frac{7}{2}H_2(g) + \frac{1}{2}N_2(g) \to (CH_3)_2 NH(g)}\\
    \color{blue}{2H_2(g) + O_2(g) \to 2H_2O(g)}\\
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
...
<p class="jt">
  Finalmente, podemos somar as duas partes (<a href="#EC12.10" style="font-weight: bold; color: black;">EC12.10</a> e <a href="#EC12.11" style="font-weight: bold; color: black;">EC12.11</a>) para obter a reação desejada (<a href="#EC12.9" style="font-weight: bold; color: black;">EC12.9</a>), graças à conservação de massa do sistema:
</p>

<div id="EC12.12" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    2CH_3(g) + NH_3(g) \to 2C(grafite) + \frac{11}{2}H_2(g) + O_2(g) + \frac{1}{2}N_2(g)\\
    2C(grafite) + \frac{11}{2}H_2(g) + O_2(g) + \frac{1}{2}N_2(g) \to (CH_3)_2NH(g) + 2 H_2O(g)\\
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$\boldsymbol{2CH_3 OH(g) + NH_3(g) \to (CH_3)_2 NH(g) + 2H_2 O(g)}$$
  </div>
