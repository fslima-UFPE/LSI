...
<div id="EC12.12" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    2CH_3(g) + NH_3(g) \to \cancel{2C(grafite)} + \bcancel[green]{\frac{11}{2}H_2(g)} + \xcancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)}\\
    \cancel{2C(grafite)} + \bcancel[green]{\frac{11}{2}H_2(g)} + \xcancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)} \to (CH_3)_2NH(g) + 2 H_2O(g)
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$2CH_3 OH(g) + NH_3(g) \to (CH_3)_2 NH(g) + 2H_2 O(g)$$
  </div>
