...
<div id="EC12.15" class="chembox-wrapper">
  <div class="chembox">
    ...
    \Delta_r H^o(T_2) = \sum_i \nu_i \cdot [{\bar H}_i^o(T_1) + \int_{T_1}^{T_2} {\bar C}_{p,i}^o dT]
    \Delta_r H^o(T_2) = \sum_i \nu_i \cdot {\bar H}_i^o(T_1) + \int_{T_1}^{T_2} \sum_i \nu_i \cdot {\bar C}_{p,i}^o dT\\
...
<p class="jt">
  A equação acima é chamada de <b>equação de Kirchhoff</b> e definimos na última linha a <i>variação de capacidade térmica da reação</i>, na forma: $\Delta_r {\bar C}_p^o = \sum_i \nu_i \cdot {\bar C}_{p,i}^o$. Esta equação permite relacionarmos a variação de entalpia de uma reação, a uma dada temperatura, com a variação de entalpia da mesma reação, em outra temperatura.
</p>
