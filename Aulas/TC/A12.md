...
<div id="EC12.5" class="chembox-wrapper">
  <div class="chembox">
    $$A(g) + D(g) \to X(g) \qquad \Delta_1 H^o = x kJ.mol^{-1} \\
    B(g) \to D(g) + Y(g) \qquad \Delta_1 H^o = y kJ.mol^{-1} $$
  </div>
  <div class="eq-numbers">
