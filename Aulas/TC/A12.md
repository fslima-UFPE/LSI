...
<div id="EC12.11" class="chembox-wrapper">
  <div class="chembox">
    ...
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$2CH_3(g) + NH_3(g) \to 2C(grafite) + \frac{11}{2}H_2(g) + O_2(g) + \frac{1}{2}N_2(g) \qquad \Delta_r H^o = +447,3 \ kJ.mol^{-1}$$
  </div>
  <div class="eq-numbers">    
...
<div id="EC12.12" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    1 \times [{\color{orange}{2C(grafite) + \frac{7}{2}H_2(g) + \frac{1}{2}N_2(g) \to (CH_3)_2 NH(g)}}] \qquad \Delta_c H^o = 1 \times (-18,6 \ kJ.mol^{-1})\\
    2 \times [{\color{blue}{H_2(g) + \frac{1}{2}O_2(g) \to H_2O(g)}}] \qquad \Delta_d H^o = 2 \times (-241,7 \ kJ.mol^{-1})\\
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$2C(grafite) + \frac{11}{2}H_2(g) + O_2(g) + \frac{1}{2}N_2(g) \to (CH_3)_2NH(g) + 2 H_2O(g) \qquad \Delta_p H^o = -502,0 \ kJ.mol^{-1}$$
  </div>
  <div class="eq-numbers">    
...
<div id="EC12.13" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    2CH_3(g) + NH_3(g) \to \cancel{2C(grafite)} + \cancel[green]{\frac{11}{2}H_2(g)} + \cancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)} \qquad \Delta_r H^o = +447,3 \ kJ.mol^{-1}\\
    \cancel{2C(grafite)} + \cancel[green]{\frac{11}{2}H_2(g)} + \cancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)} \to (CH_3)_2NH(g) + 2 H_2O(g) \qquad \Delta_p H^o = -502,0 \ kJ.mol^{-1}
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$2CH_3 OH(g) + NH_3(g) \to (CH_3)_2 NH(g) + 2H_2 O(g) \qquad \Delta H^o = -54,7 \ kJ.mol^{-1}$$
  </div>
  <div class="eq-numbers">    
