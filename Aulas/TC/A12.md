...
<p class="jt">
  Podemos imaginar essa reação ocorrendo em duas partes. A primeira é a reação de <b>decomposição</b> dos reagentes, isto é, a reação inversa da reação de formação:
</p>
...
<p class="jt">
  Finalmente, podemos somar as duas partes (<a href="#EC12.11" style="font-weight: bold; color: black;">EC12.11</a> e <a href="#EC12.12" style="font-weight: bold; color: black;">EC12.12</a>) para obter a reação desejada (<a href="#EC12.9" style="font-weight: bold; color: black;">EC12.9</a>), graças à conservação de massa do sistema:
</p>

<div id="EC12.13" class="chembox-wrapper">
  <div class="chembox">
    $$\begin{gather}    
    2CH_3(g) + NH_3(g) \to \cancel{2C(grafite)} + \cancel[green]{\frac{11}{2}H_2(g)} + \cancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)}\\
    \cancel{2C(grafite)} + \cancel[green]{\frac{11}{2}H_2(g)} + \cancel[orange]{O_2(g)} + \cancel[blue]{\frac{1}{2}N_2(g)} \to (CH_3)_2NH(g) + 2 H_2O(g)
    \end{gather}$$
    <hr style="border: 0; border-top: 1.5px solid #666; margin: 4px 0;">
    $$2CH_3 OH(g) + NH_3(g) \to (CH_3)_2 NH(g) + 2H_2 O(g)$$
  </div>
