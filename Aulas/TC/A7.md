...
<!-- Table Anchor Link Example: [Jump to Carnot Summary](#tabela-carnot) -->

<div id="tabela-carnot" class="table-wrapper">
  <table class="thermo-table">
    ...
    <tbody>
      <tr>
        <td>1. Expansão Isotérmica</td>
        <td>Reversível ($T_H$)</td>
        <td>$0$</td>
        <td>$Q_H > 0$</td>
        <td>$W_1 > 0$</td>
      </tr>
      <tr>
        <td>2. Expansão Adiabática</td>
        <td>Reversível ($T_H \to T_C$)</td>
        <td>$C_v(T_C - T_H)$</td>
        <td>$0$</td>
        <td>$W_2 > 0$</td>
      </tr>
      <tr>
        <td>3. Compressão Isotérmica</td>
        <td>Reversível ($T_C$)</td>
        <td>$0$</td>
        <td>$Q_C < 0$</td>
        <td>$W_3 < 0$</td>
      </tr>
      <tr>
        <td>4. Compressão Adiabática</td>
        <td>Reversível ($T_C \to T_H$)</td>
        <td>$C_v(T_H - T_C)$</td>
        <td>$0$</td>
        <td>$W_4 < 0$</td>
      </tr>
