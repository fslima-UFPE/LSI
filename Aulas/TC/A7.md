...
<p class="jt">
  Dentre os incontáveis caminhos possíveis, vamos discutir abaixo um caminho especial na termodinâmica: o <b>caminho reversível</b>.
</p>
...
<p class="jt">
  Caso o sistema esteja isolado, e haja um processo de expansão/compressão, então o processo é chamado de <b>adiabático reversível</b>. Ele é adiabático por não ter contato com a vizinhança (isolado) e reversível por seguir o caminho reversível.
</p>

<div id="TC7.7" class="mathbox-wrapper">
  <div class="mathbox">
    $$ w_{rev} = \int_{V_i}^{V_f} - p_{ext} dV = \int_{V_i}^{V_f} - p dV \\
