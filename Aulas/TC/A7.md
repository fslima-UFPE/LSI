...
<p class="jt">
  Do ponto de vista experimental, os valores de $\bar C_V$ para gases dependem principalmente da geometria molecular. Foi constatado que, para gases monoatômicos, $\boldsymbol{\bar C_V \approx 12,47 J \cdot K \cdot mol^{-1} = \frac{3}{2}R}$. Já moléculas lineares possuem $\boldsymbol{\bar C_V \approx 20,78 J \cdot K \cdot mol^{-1} = \frac{5}{2}R}$, e, finalmente, moléculas não lineares geralmente possuem $\boldsymbol{\bar C_V \approx 24,94 J \cdot K \cdot mol^{-1} = 3R}$. Apesar desses valores serem observados para diversas moléculas, muitas outras fogem desse padrão - mesmo quando podem ser tratadas como gases ideais. A origem desse desvio será discutida mais para frente, em Termodinâmica Estatística.
</p>
