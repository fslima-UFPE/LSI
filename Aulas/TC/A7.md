...
Vamos considerar um sistema formado por um gás confinado em um pistão que possua paredes adiabáticas. Neste caso, não será possível trocar matéria 
...
### O caminho adiabático

<p class="jt">
  Um caminho possível, também, é o caminho <b>adiabático</b>. Este caminho é tomado quando o sistema se encontra isolado, mas passa por um processo de expansão/compressão. O trabalho realizado, portanto, pode ser feito através de diferentes caminhos em uma transformação adiabática, já que o requisito para que o processo seja adiabático é que o sistema esteja isolado. Este caminho fornece uma observação fundamental para a termodinâmica. Para um processo adiabático, não importa <b>qual o caminho</b> foi tomado, ou seja, como o trabalho foi realizado, mas apenas o ponto inicial e final do sistema. Isso implica que, diferentemente do trabalho diatérmico, o trabalho adiabático surge de uma propriedade que pertence ao sistema, ao invés de pertencer ao caminho. Como o trabalho é sempre igual para o trabalho adiabático, indo de um mesmo estado inicial para um mesmo estado final, então podemos escrever:
</p>
...
<div id="TC7.6" class="mathbox-wrapper">
  ...
  <div class="eq-numbers">
    <span style="font-weight: bold; color: blue;">TC7.6</span>
  </div>
</div>


<p class="jt">
  e definimos acima a <b>energia interna, U</b>. Essa quantidade é uma propriedade do sistema, que depende apenas do estado dele. A variação dessa quantidade não depende do caminho tomado, mas apenas de estados inicial e final. Assim, chamamos esse tipo de propriedade de <b>função de estado</b>.
</p>

<p class="jt">
  Funções de estado são fundamentais em termodinâmica. O motivo? Dentre outros, elas permitem que, dois cientistas, em lugares diferentes do mundo, trabalhando com o mesmo sistema, possam reportar propriedades deste <b>sem</b> se preocupar com o caminho tomado, mas apenas os estados inicial e final. Isso é de grande auxílio experimental, pois é muito difícil reproduzir exatamente o mesmo caminho entre dois pontos, com equipamentos e reagentes diferentes!
</p>

<p class="jt">
  Outra observação fundamental extraída de processos adiabáticos é que há uma relação inversa entre o volume molar do sistema e a temperatura dele. Isso significa que em uma expansão adiabática há uma diminuição da temperatura do sistema, e em uma compressão adiabática há um aumento na temperatura do sistema. Essa variação, que corresponde a uma variação na energia interna do sistema, depende de uma constante de proporcionalidade, que depende das propriedades do sistema, e é chamada de <b>capacidade térmica a volume constante</b>, $C_V$. Assim, podemos escrever:
</p>

<div id="TC7.7" class="mathbox-wrapper">
  <div class="mathbox">
    $${\color{blue}{\boldsymbol{dU = C_V dT}}} \\
...
<p class="jt">
  Caso o sistema esteja isolado, e haja um processo de expansão/compressão, então o processo é chamado de <b>adiabático reversível</b>. Ele é adiabático por não ter contato com a vizinhança (isolado) e reversível por seguir o caminho quase-estático. Para este sistema, se o gás for ideal, podemos escrever:
</p>
