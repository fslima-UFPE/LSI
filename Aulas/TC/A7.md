...
<div id="TC7.11" class="mathbox-wrapper">
  <div class="mathbox">
    ...
    \color{blue}{\boldsymbol{dU = \bar C_V(T) dT}}$$
  </div>
  <div class="eq-numbers">
...
<p class="jt">
e substituímos $dU = C_V(T) dT$ por se tratar de um G.I., e a equação <a href="#TC7.12" style="color: blue; font-style: italic;">TC7.12</a> foi obtida considerando que $\bar C_V(T) = \bar C_V$. Esta equação mostra que, de fato, há uma variação de temperatura com a variação de volume do sistema, e essa relação depende, também, de $\bar C_V$!
</p>

<p class="jt">
  Assim, podemos nos perguntar: se há variação de temperatura em uma e/c adiabática reversível, por quê a temperatura do sistema permanece constante em <a href="#TC7.9" style="color: blue; font-style: italic;">TC7.9</a>, um processo isotérmico reversível? Naquele sistema, a temperatura não varia por conta da vizinhança! Podemos demonstrar isso, utilizando o fato de $dU = C_V(T) dT$ para um gás ideal, fazendo com que não haja variação de energia interna, pois a variação de temperatura é zero. Logo, $q_{rev} = -w_{rev}$. Então a vizinhança foi resopnsável por fornecer/absorver energia na forma de calor naquele processo, garantindo que a temperatura não variasse!
</p>
