...
<div class="toolbox" id="work-tool">
    ...
    <p class="jt">
        Este Laboratório Virtual permite visualizar a diferença no trabalho realizado durante a expansão ou compressão isotérmica de um gás ideal. Compare a isoterma contínua (caminho reversível) com os degraus de pressão (caminho irreversível em etapas).
    </p>
    ...
    <div>
        ...
        <div class="jsbox-input-row">
            <label title="Parâmetro a (L²·bar/mol² ou equivalente)">Constante a:</label>
            <input type="number" class="param-a jsbox-input" value="1.36" step="0.01">
        </div>
        <div class="jsbox-input-row">
            <label title="Covolume b (L/mol)">Constante b:</label>
            <input type="number" class="param-b jsbox-input" value="0.0318" step="0.001">
        </div>
        <div class="jsbox-input-row">
            <label title="Parâmetro de energia ε/k (K)">ε/k (K):</label>
