...
<div id="TC7.11" class="mathbox-wrapper">
  <div class="mathbox">
    ...
    $$ \color{red}{\boldsymbol{C_V(T) = \left( \frac{\partial U}{partial T} \right)_V}} \\
    $$ \color{blue}{\boldsymbol{\bar C_V(T) = \left( \frac{\partial \bar U}{partial T} \right)_V}}$$ 
  </div>
  <div class="eq-numbers">
    <span style="font-weight: bold; color: blue;">TC7.11</span>
  </div>  
</div>

<p class="jt">
e chamamos de $C_V(T)$ a capacidade térmica a volume constante de um sistema. Ela é a medida de proporcionalidade entre variação de energia interna e de temperatura, a uma dada temperatura. Ela é de grande importância em sistemas termodinâmicos, como veremos.
</p>
