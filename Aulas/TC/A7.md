...
<div class="simulation-box">
  ...
  <button class="stir-btn" id="start-btn">Realizar Trabalho (Agitar)</button>
</div>
...
<script>
  ...
  function animateSystem() {
    ...
    progress += 0.0012;     // Synchronized slightly lower to fit slower motion
    ...
    const wobbleX = Math.sin(rotationAngle * 0.15) * 0.8;
    const wobbleY = Math.cos(rotationAngle * 0.22) * 0.8;
