...
<p class="jt">
  Como todos os pontos do caminho estão em equilíbrio com a vizinhança, então o processo reversível é também <b>isotérmico</b>! Daí, podemos calcular o trabalho reversível através de:
</p>
...
<div class="toolbox" id="work-tool">
    ...
    <p class="jt">
        Este Laboratório Virtual permite visualizar a diferença no trabalho realizado durante a expansão ou compressão isotérmica de um gás (ideal ou real). Compare a isoterma contínua (caminho reversível) com os degraus de pressão (caminho irreversível) e observe como parâmetros intermoleculares microscópicos afetam o trabalho macroscópico.
    </p>
    ...
    <div class="toolbox-content">
        <div class="jsbox-control-panel">
            <div class="jsbox-controls-grid">
                <div>
                    ...
                    <div class="jsbox-input-row">
                        ...
                        <input type="number" class="param-s jsbox-input" value="3" step="1" min="1">
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="jsbox-input-row" style="margin-bottom: 10px;">
                        ...
                        <select class="param-model jsbox-input">
                            ...
                            <option value="sw">Poço Quadrado (Square-Well)</option>
                    ...
                    <div class="jsbox-input-row row-sigma" style="display:none;">
                        ...
                        <input type="number" class="param-sigma jsbox-input" value="3.0" step="0.1">
                    </div>
                    <div class="jsbox-input-row row-epsk" style="display:none;">
                        <label title="Parâmetro de energia (Kelvin)">ε/k (K):</label>
                        <input type="number" class="param-epsk jsbox-input" value="100" step="1">
                    </div>
            ...
            <div style="margin-top: 15px;">
                <button class="generate-work-btn jsbox-btn jsbox-btn-primary">CALCULAR E ATUALIZAR GRÁFICO</button>
            </div>
        </div> 
