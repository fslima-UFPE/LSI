...
<script>
  ...
  function animateSystem() {
    ...
    progress += 0.003;    // Tweak to change melting time duration
    rotationAngle += 6;   // Angular speed of the stirrer blade
    ...
    // 4. Smoothly fade out the ice microstates as entropy increases
