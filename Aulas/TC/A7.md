      ...
      <g id="g19899">
        <g id="g2073">
          <g id="g19622">
            ...
            <g id="motion-waves" transform="translate(-69.588642,40.733485)" style="opacity: 0; transition: opacity 0.2s;">
...
<script>
  ...
  function animateSystem() {
    if (progress >= 1) {
      ...
      motionWaves.style.opacity = 0; // Flow stops immediately
      isRunning = false;
      startBtn.innerText = "Gelo Derretido (Equilíbrio Atingido)";
    ...
    // 2. Apply clean rotational mechanics around the true absolute pin center
    stirrerContainer.setAttribute('transform', `rotate(${rotationAngle}, ${absoluteCenterX}, ${absoluteCenterY})`);

    // 3. Smoothly fade out the ice microstates as entropy increases
    iceCubes.style.opacity = 1 - progress;

    // 4. project the fluid flow ripples into view while work is actively performed
    motionWaves.style.opacity = 0.85;
