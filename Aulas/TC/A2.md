...
<div id="TC2.7" class="mathbox-wrapper">
  <div class="mathbox">
      $$\color{blue}{\boldsymbol{P = \frac{f^2 \cdot m}{N} = k_2 \frac{N \cdot T}{A}}}$$
  </div>
  <div class="eq-numbers">
...
<p class="jt">
Assim como $k_1$, $k_2$ também é uma constante de proporcionalidade, naturalmente com unidades diferentes. Note que as dependências de $P$ e $f$ com as variáveis $T, N, L$ (raiz de $A$) e $m$ são distintas! Para ver na prática o efeito de cada uma desta propriedades na frequência e na pressão, experimente utilizar o laboratório virtual abaixo.
</p>
