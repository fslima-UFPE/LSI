...
<!--        <p class="toolbox-subtitle">Pressão e frequência de colisão</p> --!>
  </div>
  <div class="toolbox-content">
      ...
      <div class="jsbox-card" style="margin: 40px 0; border: 1px solid #d1d5da;">
        ...
        <div class="jsbox-card-body" style="display: block; padding: 25px; background: #fff;">
          ...
          <div id="TBC2.1" class="mathbox-wrapper">
            <div class="mathbox">
                $$\color{blue}{\boldsymbol{f = k_1 \frac{N}{L} \sqrt{\frac{T}{m}}}}$$
            </div>
            <div class="eq-numbers">
              <span style="font-weight: bold; color: blue;">TBC2.1</span>
            </div>
          </div>
          ...
          <div id="TBC2.2" class="mathbox-wrapper">
            <div class="mathbox">
                $$\color{blue}{\boldsymbol{p = \frac{f^2 \cdot m}{N} = k_2 \frac{N \cdot T}{L^2}}}$$
            </div>
            <div class="eq-numbers">
              <span style="font-weight: bold; color: blue;">TBC2.2</span>
            </div>
          </div>
          ...
          <div class="jsbox-controls-grid" style="display: flex; flex-wrap: wrap; gap: 20px;">
            ...
            <div style="display: flex; flex-direction: column; justify-content: center; flex: 1 1 200px;">
              <p style="font-size: 0.85em; color: #666; text-align: center; margin-bottom: 15px;">
                Preencha os 5 pontos acima e clique para calcular as equações <a href="#TBC2.1" style="color: blue; font-style: italic;">TBC2.1</a> e <a href="#TBC2.2" style="color: blue; font-style: italic;">TBC2.2</a>.
              </p>
