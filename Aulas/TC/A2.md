...
<div class="toolbox">
  ...
  <div class="toolbox-content">
      ...
      <p class="jt">
      Podemos imaginar um gás ideal bidimensional, isto é, um gás que pode se mover apenas no plano <i>xy</i>, ao invés de um espaço tridimensional. Apesar de bidimensional, este gás ainda se comporta idealmente: é puntiforme e não interage com outras moléculas. Vimos que a origem da pressão de um gás ideal é a colisão das moléculas com as paredes do recipiente - único termo avaliado na equação <a href="#TC2.1" style="color: blue; font-style: italic;">TC2.1</a>. A caixa de simulação abaixo permite que você varie o número de partículas na caixa ($N$), a temperatura do sistema ($T$), a massa das partículas ($m$), e a areasta da caixa ($L$). Ao final da simulação, você poderá visualizar o deslocamento das partículas, bem como a frequência de colisão das partículas com as paredes da caixa 2D. Como varia a frequência de colisão com as variáveis acima?
      </p>
      ...
      <div id="LVC2.1" class="mathbox-wrapper">
          ...
          <p class="jt">
            Assim como $k_1$, $k_2$ também é uma constante de proporcionalidade, e ambas possuem unidades diferentes. Note que as dependências de $p$ e $f$ com as variáveis $T, N, L$ e $m$ são distintas! É interessante notar que a frequência de colisão para um sistema tridimensional seria proporcional às mesmas variáveis do sistema bidimensional, mas com $k_1$ diferente. Já a pressão, esta também seria proporcional a $f^2$, a $m$ e inversamente propocional a $N$. Contudo, seria também inversamente proporcional a $L$, fazendo com que a pressão seja proporcional a $1/V$. Claramente, a constante $k_2$ também seria diferente. Entretanto, ressaltamos aqui a utilidade do modelo bidimensional: a origem da pressão é a mesma do sistema tridimensional.
          </p>
