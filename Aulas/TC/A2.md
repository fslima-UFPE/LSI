  ...
  <div class="toolbox-content">
    ...
    <div class="interactive-area" id="gas-ideal">
      ...
      <div id="ui-visualization" class="jsbox-vis-layout" style="display: none; flex-wrap: wrap; gap: 20px; width: 100%; box-sizing: border-box;">
        ...
        <div class="jsbox-vis-left" style="flex: 1 1 320px; max-width: 100%;">
        ...
        <div class="jsbox-vis-right" style="flex: 1 1 320px; max-width: 100%;">
          <div class="jsbox-card" style="height: 100%;">
            <div class="jsbox-card-body" style="justify-content: center; height: 100%;">
              ...
              <canvas id="freq-canvas" width="600" height="600" class="jsbox-chart" style="width: 100%;"></canvas>
            </div>
          </div>
        </div>
    ...
    <div id="lab-graficos">
      ...
      <div class="jsbox-vis-layout" style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 20px; width: 100%; box-sizing: border-box;">
        ...
        <div class="jsbox-vis-left" style="flex: 1 1 320px; min-width: 0; max-width: 100%;">
          <div class="jsbox-card">
        ...
        <div class="jsbox-vis-right" style="flex: 1 1 320px; min-width: 0; max-width: 100%;">
          <div class="jsbox-card">
