...
<div class="toolbox-content">
  ...
  <div class="jsbox-col-title" style="font-size: 1.2em; border-bottom: 2px solid #eee; padding-bottom: 10px; margin-bottom: 20px; color: #003366;">
    1. Simulador do Gás Ideal
  </div>

  <div class="interactive-area" id="gas-ideal">
    
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px; align-items: stretch;">
        ...
        <div style="background: #fdfdfd; border-radius: 8px; border: 1px solid #eee; padding: 10px; min-height: 120px;">
          <div class="jsbox-col-title" style="color: #666; font-size: 0.9em; border-bottom: 1px solid #eee; margin-bottom: 8px; display: flex; justify-content: space-between; align-items: center;">
            <span style="font-weight: bold;">Estatísticas Atuais</span>
          ...
          <div id="history-box-content" style="font-family: monospace;">
            <p style="color: #999; font-style: italic; font-size: 0.85em;">Aguardando simulação...</p>
          </div>
        </div>
    ...
    <div id="ui-progress" class="jsbox-alert" style="display: none; text-align: center; margin: 10px 0;">
      <span id="progress-text" style="font-weight: bold;">Progresso: 0%</span>
    </div>

    <div id="ui-visualization" style="display: none; flex-wrap: wrap; gap: 20px; align-items: flex-start; margin-top: 20px;">
        
        <div style="flex: 1; min-width: 320px;">
            <div class="jsbox-card">
                <div class="jsbox-card-header">Câmera da Simulação</div>
                <div class="jsbox-card-body">
                    <div class="jsbox-player-bar" style="display: flex; gap: 10px; margin-bottom: 10px;">
                    ...
                    <canvas id="sim-canvas" width="900" height="900" style="width: 100%; border: 1px solid #ccc; background: #fff; border-radius: 4px;"></canvas>
                </div>
            </div>
        </div>
        ...
        <div style="flex: 1; min-width: 320px;">
            <div class="jsbox-card">
                <div class="jsbox-card-header">Frequência de Colisão (Paredes)</div>
                <div class="jsbox-card-body">
                    <canvas id="freq-canvas" width="400" height="350" style="width: 100%; border: 1px solid #eee; border-radius: 4px;"></canvas>
                    <p style="font-size: 0.8em; color: #666; margin-top: 5px; text-align: center;">
                      Este gráfico mostra o número de impactos nas paredes ao longo do tempo.
                    </p>
                </div>
            </div>
        </div>
  ...
  <div class="jsbox-card" style="margin: 40px 0; border: 1px solid #d1d5da;">
    <div class="jsbox-card-header" style="background: #f1f3f5; color: #333; font-weight: bold;">
      Relação Matemática entre a Frequência e a Pressão
    </div>
    <div class="jsbox-card-body" style="display: block; padding: 25px; background: #fff;">
      <p>
        A relação entre a frequência de colisão $f$ e as variáveis termodinâmicas é dada por:
      </p>
      <div class="mathbox" style="text-align: center; margin: 20px 0;">
          $$\color{blue}{\boldsymbol{f = k_1 \frac{N}{L} \sqrt{\frac{T}{m}}}}$$
          <small>(Equação TC2.6)</small>
      </div>
      <p>
        A pressão ($p$), por sua vez, depende do momento transferido em cada colisão:
      </p>
      <div class="mathbox" style="text-align: center; margin: 20px 0;">
          $$\color{blue}{\boldsymbol{p = \frac{f \cdot \Delta p}{L} = k_2 \frac{N \cdot T}{L^2}}}$$
          <small>(Equação TC2.7)</small>
      </div>
    </div>
  </div>
  ...
  <div id="lab-graficos">
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 20px;">
        ...
        <div>
          ...
          <div class="jsbox-input-row" style="margin-bottom: 15px; background: #e9ecef; padding: 5px; border-radius: 5px;">
            ...
            <select id="sel-var" class="jsbox-input">
          ...
          <div class="jsbox-input-row"><label>N fixo:</label><input type="number" id="base-n" class="jsbox-input" value="150"></div>
        ...
        <div>
          <div class="jsbox-col-title sys">Valores de Teste</div>
        ...
        <div style="display: flex; flex-direction: column; justify-content: center;">
          <button id="btn-plot" class="jsbox-btn jsbox-btn-primary" style="padding: 15px; font-weight: bold;">
    ...
    <div class="jsbox-vis-layout" style="display: flex; flex-wrap: wrap; gap: 20px; margin-top: 20px;">
      <div style="flex: 1 1 300px;">
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="background: #003366;">Frequência vs Variável</div>
          <div class="jsbox-card-body">
      ...
      <div style="flex: 1 1 300px;">
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="background: #d9534f;">Pressão vs Variável</div>
          <div class="jsbox-card-body">
