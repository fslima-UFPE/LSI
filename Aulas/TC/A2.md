...
<div class="toolbox-content">
      ...
      <div class="jsbox-controls-grid">
        ...
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <button id="btn-clear-history" style="font-size: 0.75em; padding: 2px 8px; cursor: pointer; border-radius: 4px; font-weight: bold;">Limpar</button>
          </div>
          <div id="history-box-content" class="jsbox-card-body" style="font-family: monospace; text-align: center;">
  ...
  <div class="jsbox-card" style="margin: 40px 0;">
    ...
    <div class="jsbox-card-body" style="display: block; padding: 25px;">
      ...
      <div class="mathbox-wrapper">
        <div class="mathbox">
          $$\boldsymbol{f = k_1 \frac{N}{L} \sqrt{\frac{T}{m}}}$$
        </div>
        <div class="eq-numbers">
          <span>(TC2.6)</span>
        </div>
      ...
      <div class="mathbox-wrapper">
        <div class="mathbox">
          $$\boldsymbol{p = \frac{f \cdot \Delta p}{L} = k_2 \frac{N \cdot T}{L^2}}$$
        </div>
        <div class="eq-numbers">
          <span>(TC2.7)</span>
        </div>
