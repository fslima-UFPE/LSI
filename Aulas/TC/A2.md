...
<div class="toolbox">
  ...
  <div class="toolbox-content">
      ...
      <p class="jt">
            No laboratório virtual da seção anterior, é possível visualizar como as mudanças dos valores de temperatura ($T$), aresta da caixa ($L$), massa ($m$) e número das partículas ($N$) afetam a frequência de colisão das moléculas com as paredes da caixa. A relação entre a frequência $f$ e as demais variáveis é conhecida e dada por:
      </p>
