...
<div class="toolbox-content">
    ...
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid">
        ...
        <div class="jsbox-card">
          <div class="jsbox-card-header" style="display: flex; justify-content: space-between; align-items: center;">
            <span>Histórico de Simulações</span>
            <button id="btn-clear-history" style="font-size: 0.75em; padding: 2px 8px; cursor: pointer; border-radius: 4px; font-weight: bold; background: #fff; color: #d9534f; border: 1px solid #ccc;">Limpar</button>
          </div>
          <div id="history-box-content" class="jsbox-card-body" style="font-family: monospace; text-align: center; display: block; overflow-y: auto; max-height: 140px;">
          </div>
        </div>

        <div style="display: flex; flex-direction: column; justify-content: center;">
          <button id="btn-run" class="jsbox-btn jsbox-btn-primary">
            CALCULAR SIMULAÇÃO
          </button>
        </div>
    ...
    <div id="ui-visualization" class="jsbox-vis-layout" style="display: none;">
        ...
        <div style="flex: 1; min-width: 320px;">
            <div class="jsbox-card">
                ...
                <div class="jsbox-card-body">
                    <canvas id="freq-canvas" width="400" height="350" class="jsbox-chart"></canvas>
                    <p class="jsbox-legend">
                      A linha pontilhada azul representa a frequência média.
                    </p>
                </div>
            </div>
        </div>
  ...
  <div class="jsbox-card" style="margin: 40px 0;">
    <div class="jsbox-card-header">
      Relação Matemática entre a Frequência e a Pressão
    </div>
    <div class="jsbox-card-body" style="display: block; padding: 25px;">
      <p>
  ...
  <div id="lab-graficos">
    <div class="jsbox-control-panel">
      <div class="jsbox-controls-grid">
        ...
        <div style="display: flex; flex-direction: column; justify-content: center;">
          <button id="btn-plot" class="jsbox-btn jsbox-btn-primary">
    ...
    <div class="jsbox-vis-layout">
      <div style="flex: 1 1 300px;">
        <div class="jsbox-card">
          <div class="jsbox-card-header">Frequência vs Variável</div>
          <div class="jsbox-card-body">
            <canvas id="chart-freq" class="jsbox-chart" style="height: 250px;"></canvas>
          </div>
        </div>
      </div>
      <div style="flex: 1 1 300px;">
        <div class="jsbox-card">
          <div class="jsbox-card-header">Pressão vs Variável</div>
          <div class="jsbox-card-body">
            <canvas id="chart-press" class="jsbox-chart" style="height: 250px;"></canvas>
          </div>
        </div>
      </div>
    </div>
