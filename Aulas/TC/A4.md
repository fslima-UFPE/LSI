    ...
    <div class="toolbox-content">
        <div class="jsbox-control-panel">
            <div class="jsbox-controls-grid">
                ...
                <div>
                    ...
                    <div class="jsbox-input-row">
                        ...
                        <select id="moleculeSelect" class="jsbox-input">
                            <option value="H2O" selected>H<sub>2</sub>O</option>
                ...
                <div>
                    <div class="jsbox-col-title opt">Controle de Pressão</div>
        ...
        <div class="jsbox-card">
            <div class="jsbox-card-header">Gráfico de Isoterma</div>
