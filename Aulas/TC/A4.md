                ...
                <div>
                    ...
                    <div class="jsbox-input-row">
                        ...
                        <select id="moleculeSelect" class="jsbox-input">
                            <option value="H2O" selected>H<sub>2</sub></option>
                            <option value="CO2">COH<sub>2</sub></option>
                            <option value="N2">H<sub>2</sub></option>
                        </select>
                    </div>
                    ...
                    <div class="jsbox-input-row">
                        ...
                        <div style="display:flex; gap:5px; width:50%; flex-direction: column;">
                            <input type="number" id="tempInput" class="jsbox-input" value="550" step="5" style="width:100%">
